...
class CustomerBenefitGrantDownloadables
{
     ...
     */
    public function __construct(\DateTime $createdAt, string $id, string $customerId, string $benefitId, bool $isGranted, bool $isRevoked, BenefitDownloadablesSubscriber $benefit, BenefitGrantDownloadablesProperties $properties, ?\DateTime $modifiedAt = null, ?\DateTime $grantedAt = null, ?\DateTime $revokedAt = null, ?string $subscriptionId = null, ?string $orderId = null)
    {
